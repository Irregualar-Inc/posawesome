  ...
  <div>
    ...
    <v-dialog v-model="codeDialog" max-width="330" @click:outside="clearCode">
      <v-card>
        ...
        <v-card-text>
          <v-text-field v-model="code" label="Code" type="password" maxlength="6"></v-text-field>
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn color="primary" @click="validateCode">{{ __("Submit") }}</v-btn>
          <v-btn color="warning" @click="clearCode">{{ __("Clear") }}</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
    <v-card
          ...
          <v-row no-gutters class="pa-1 pt-2 pl-0">
            <v-col cols="6" class="pa-1">
              <v-btn
                block
                class="pa-0"
                :class="{ 'disable-events': !pos_profile.posa_allow_held }"
                color="warning"
                dark
